    ...
    while not end_game:
        ...
        if not end_game:
            ...
            if 'draw' not in info:
                ...
                print('draw')
            print(f"end of episode {episode} {player_1_name}'s score {players[player_1_name].score} {player_2_name}'s score {players[player_2_name].score}")
            episode += 1
        else:
            print(f'{player_name} gives up. end of the game.')
